...
<body class="min-h-screen bg-gig-bg flex">
    ...
    <!-- 
        ...
        Uses a fixed width and flex to handle content
    -->
    <aside class="w-20 md:w-64 flex-shrink-0 bg-white border-r border-gray-100 p-4 sticky top-0 h-screen transition-all duration-300">
        <div class="flex flex-col h-full">
            ...
            <div class="hidden md:flex items-center space-x-3 pb-8 border-b border-gray-100 mb-6">
                <img src="https://placehold.co/40x40/6B46C1/ffffff?text=JD" alt="User Avatar" class="rounded-full w-10 h-10 object-cover border-2 border-gig-purple">
                <div>
                    <span class="block text-sm font-semibold text-gray-900">John Doe</span>
                    <span class="block text-xs text-gray-500">Recruiter</span>
                </div>
            </div>
            ...
            <!-- Footer: Logout and Branding -->
            <div class="mt-auto pt-6 border-t border-gray-100 space-y-4">
                <!-- Log out Button -->
                <a href="#" class="flex items-center p-3 text-gray-600 hover:bg-red-100 hover:text-red-600 rounded-xl transition duration-150">
                    <svg class="w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- 
        2. Main Content Area 
    -->
    <main class="flex-grow p-6 md:p-10 job-list">
        <!-- Top Header -->
        <header class="mb-8">
            <h1 class="text-4xl font-extrabold text-gray-900 mb-1">Hi, Angela 👋</h1>
